...
class Binance():
    ...
    methods = {
            ...
            'cancelOrders':      {'url': 'api/v3/openOrders', 'method': 'DELETE', 'private': True},
            ...
            #sapi
            'marginTransfer': {'url': '/sapi/v1/margin/transfer', 'method': 'GET', 'private':True},
            ...
            'marginOpenOrdersDelete': {'url': '/sapi/v1/margin/openOrders', 'method': 'DELETE', 'private':True},
            ...
            'magrinIsolatedAccount' : {'url': '/sapi/v1/margin/isolated/account', 'method': 'GET', 'private':True},
            'magrinIsolatedTransfer' : {'url': '/sapi/v1/margin/isolated/transfer', 'method': 'GET', 'private':True},
